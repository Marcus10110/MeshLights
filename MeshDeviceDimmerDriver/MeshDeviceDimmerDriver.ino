...
Dimmer dimmers[MAX_DIMMER_COUNT] = {
  Dimmer(3, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(4, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(5, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(6, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(7, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(8, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(9, DIMMER_RAMP, RAMP_TIME ),
  Dimmer(10, DIMMER_RAMP, RAMP_TIME )
};
