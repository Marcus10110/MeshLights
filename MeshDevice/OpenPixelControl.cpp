...
OpenPixelControl::OpenPixelControl( StateManager* state_manager, std::function<void( uint8_t*, uint16_t )> render_callback )
    : mStateManager( state_manager ), mRenderCallback( render_callback )
{
}
